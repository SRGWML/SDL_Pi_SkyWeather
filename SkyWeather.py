...
if (sys.version_info >= (3, 0)):
    sys.path.append('./Adafruit_Python_BMP/Adafruit_BMP')
else:
    # original
...
# 2020-04-13 commented out as loaded from config or conflocal (preferred)
...
# 2020-04-13 commented out as loaded from config or conflocal
...
if (sys.version_info >= (3, 0)):
    ...
    # import RTC_SDL_DS3231 as SDL_DS3231
else:
    # original
    import SDL_DS3231
...
# for Python 3
if (sys.version_info >= (3, 0)):
    from SDL_Pi_SI1145 import SDL_Pi_SI1145
else:
    # original
...
# for Python 3
if (sys.version_info >= (3, 0)):
    from SI1145Lux import SI1145_IR_to_Lux
    from SI1145Lux import SI1145_VIS_to_Lux
else:
    # original
    import SI1145Lux
...
try:
    # for Python 3
    if (sys.version_info >= (3, 0)):
        tca9545 = SDL_Pi_TCA9545(addr=TCA9545_ADDRESS, bus_enable = TCA9545_CONFIG_BUS0)
    else:
        # original
...
try:
    ...
    # for Python 3
    if (sys.version_info >= (3, 0)):
        IR_Lux = SI1145_IR_to_Lux(IR)
        vis_Lux = SI1145_VIS_to_Lux(vis)
    else:
...
# for Python 3
if (sys.version_info >= (3, 0)):
    weatherStation = SDL_Pi_WeatherRack(config.anemometerPin, config.rainPin, 0,0, SDL_MODE_I2C_ADS1015)
else:
    # original
...
# for Python 3
if (sys.version_info >= (3, 0)):
    as3935 = RPi_AS3935.RPi_AS3935(address=0x02, bus=1)
else:
    # original
...
try:
    ...
    # for Python 3
    if (sys.version_info >= (3, 0)):
        as3935 = RPi_AS3935.RPi_AS3935(address=0x03, bus=1)
    else:
        # original
